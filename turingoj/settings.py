...
with open('/etc/secret_key_turingoj.txt') as f:
...
INSTALLED_APPS = [
    'django.contrib.admin',       #for applying migrations first comment this and apply migration to the coders app and then uncomment and migrate
    'django.contrib.auth',
